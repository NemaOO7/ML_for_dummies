...
class dataprocessing:
    ...
    def filling_missingdatastring(self):    
        try:            
    ...
    def labelencoding(self):    
        ...
        try:
            self.dataset4=self.dataset
            self.dataset4[self.col]=self.dataset[self.col].apply(LabelEncoder().fit_transform)
            #self.dataset[self.col]=self.dataset[self.col].apply((lambda col: le.fit_transform(col)))
        except:
            print(sys.exc_info()[0], "occurred.")
    def  onehotencoding(self,ncol):
        """
        ...
        try:
            ...
            print(sys.exc_info()[0], "occurred.")
    def removeoutliner(self,ncol=None):
        """
